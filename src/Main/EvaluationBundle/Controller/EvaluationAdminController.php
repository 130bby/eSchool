...
use Main\EvaluationBundle\Entity\Evaluation;
use Main\EvaluationBundle\Form\EvaluationType;
        ...
        if ($this->getRestMethod() == 'POST') {
            ...
            if ($isFormValid && (!$this->isInPreviewMode() || $this->isPreviewApproved())) {
                ...
                try {
					...
					if (isset($data['savoirs']))
						$object->setSavoirs(array_values($data['savoirs']));
					else
						$object->setSavoirs(array());
