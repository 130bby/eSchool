...
class ProfTbcAdmin extends Admin
{

	protected $baseRouteName = 'sonata_admin_prof_tbc';
	protected $baseRoutePattern = 'prof_tbc';
	...
	public function createQuery($context = 'list')
	{
		...
		$query->setParameter('my_param', '%ROLE_PROF_TBC%');
		return $query;
	}
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            'actions' => array(
                'Confirm' => array(
                    'template' => 'MainUserBundle:Admin:confirm_prof.html.twig'
                )
            )
        ))
        ;
